...
class ResultManagementSystem:
    def __init__(self,home):
        ...
        #Title of project
        title=Label(self.home,text="Student Result Management System",padx=10,compound=LEFT,image=self.logo,font=("times new roman",20,"bold"),bg="Navy Blue",fg="white").place(x=0,y=0,relwidth=1,height=50)

        # Menu 
        Frame = LabelFrame(self.home,text="Menu",font=("times new roman",20,"bold"),bg="white")
        ...
        #Footer
        footer=Label(self.home,text="Contact Me: \n  rahulbabuoffl@gmail.com",font=("times new roman",13,"bold"),bg="grey",fg="white").pack(side=BOTTOM,fill=X)
    ...
    def update_details(self):
        ...
        try:
            ...
            cr=cur.fetchall()
            self.totalCourse.config(text=f"Total Courses\n[{str(len(cr))}]")
