...
class Login:
    def __init__(self, home):
        self.home = home
        self.home.title("Unified Login Page - SRMS")
        ...
        # Login title
        title=Label(Frame_login,text="User Login",font=("Times New Roman",25,"bold"),fg="navy blue",bg="light gray").place(x=163,y=20)
