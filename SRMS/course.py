...
class CourseClass:
    ...
    #Categories of Courses
        courseName = Label(self.home,text="Subject Code",font=("times new roman",15,"bold"),bg="white").place(x=10,y=60)
        duration = Label(self.home,text="Sub Name",font=("times new roman",15,"bold"),bg="white").place(x=10,y=100)
        charges = Label(self.home,text="Type",font=("times new roman",15,"bold"),bg="white").place(x=10,y=140)
        description = Label(self.home,text="Credits",font=("times new roman",15,"bold"),bg="white").place(x=10,y=180)
    ...
    #Entry Fields
        ...
        self.description1.place(x=150,y=180,width=200,height=30)
    ...
    #Content
        ...
        self.C_Frame.place(x=720,y=60,width=470,height=360)
    ...
    #Headings and Coloumns for the tables
        ...
        self.CourseTable.heading("name",text="Sub Code")
        self.CourseTable.heading("duration",text="Sub Name")
        self.CourseTable.heading("charges",text="Type")
        self.CourseTable.heading("description",text="Credits")
        ...
        self.CourseTable.column("description",width=80)
        ...
        try:
            if self.var_course.get()=="":
                ...
                if row==None:
                    ...
                    p=messagebox.askyesno("Confirm","Do you want to delete",parent=self.home)
                    if p==True:
    ...
    def add(self):
        ...
        try:
            if self.var_course.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error, Course name already exist!",parent=self.home)
                else:
                    ...
                    conn.commit()
                    messagebox.showinfo("Woah!","Course Added Successfully",parent=self.home)
                    self.show()
